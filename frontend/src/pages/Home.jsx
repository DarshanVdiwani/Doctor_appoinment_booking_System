                ...
                <div className="flex flex-col lg:flex-row gap-[90px] items-center justify-between">
                    ...
                    <div>
                        <div className="lg:w-[570px]">
                            ...
                            <p className='text_para'>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Modi aut necessitatibus ullam veritatis. Rem ipsam, laudantium explicabo esse natus fugiat. Nulla, ut sint aliquam architecto quasi libero, maxime perspiciatis voluptatum repellendus est inventore ipsa eum tenetur illum illo magnam dignissimos, cumque officia quam adipisci excepturi cupiditate repellat provident.</p>
            ...
            <div className="container">
                <div className="flex items-center justify-between flex-col lg:flex-row">
                    ...
                    <div className='relative z-10 xl:w-[770px] flex justify-end mt-[50px] lg:mt-0'>
                        ...
                        <div className="w-[150px] lg:w-[248px] bg-white absolute bottom-[50px] left-0 md:bottom-[100px] md:left-5 z-20 p-2 pb-3 lg:pt-4 lg:px-4 lg:pb-[26px] rounded-[10x] ">
