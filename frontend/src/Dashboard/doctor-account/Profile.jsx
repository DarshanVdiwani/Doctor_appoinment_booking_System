/* eslint-disablr react/prop-types */
...
const Profile = ({ doctorData }) => {
    ...
    const addQualification = e => {
        ...
        addItem('qualifications', {
            ...
            endingDate: '',
            degree: 'PHD',
            university: 'HMT Medical college',
        })
    }
    ...
    return (
        <div>
            ...
            <form action="">
                        ...
                        <div key={index}>
                            <div>
                                <div className="grid grid-cols-2 md:grid-cols-4 mb-[30px]  gap-5">
                                    ...
                                    <div>
                                        <p className="form_label">Endind Time*</p>
                                        <input
                                            type="time"
                                            name="endingTime"
                ...
                <div className="mt-7 ">
                    <button type="submit" onClick={updateProfileHandler} className="bg-primaryColor text-white text-[18px] leadign-[30px] w-full py-3 px-4 rounded-lg">Update Profile</button>
                </div>
