                                ...
                                <div className="flex items-center gap-4 mb-10">
                                    ...
                                    <div>
                                        ...
                                        <div className="flex items-center gap-[6px]">
                                            <span className="flex items-center gap-[6px] text-headingColor text-[14px] leading-5 lg:taxt-[16px] lg:leading-6 font-semibold ">
                                                <img src={starIcon} alt="" />
                                                {data.averageRating}
                                            </span>
                                            <span className="text-textColor text-[14px] leading-5 lg:taxt-[16px] lg:leading-6 font-semibold ">
                                                ({data.totalRating})
                                            </span>
                                        </div>
